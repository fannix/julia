...
# img = load("WashingtonianAugust2019SOL-copy.jpg")
# img = load("WashingtonianDecember2016SOLUTIONcopy.jpg")
# img = load("jpg/WashingtonianNovember2018SOL-copy.jpg")

img = load("jpg/WashingtonianJuly2016SOL-copy.jpg")
...
for i in 1:length(idx1)-1
    for j in 1:length(idx2)-1
        ...
        save("jpg/$i-$j.jpg", bin_img[begin1: end1, begin2: end2])
    end
end